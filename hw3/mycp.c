/*===============================================================
[Program Name] :	hw3/mycp.c
[Description]  :	it creats copied binary file from source(argv[1]) with systemcall functions(read,write)
...
[Calls]        :	None
[특기사항]     :	Usage : ./mycp <sourceFile> <destination>
==================================================================*/
#include <stdio.h>
#include <fcntl.h>
#include <unistd.h>
